 ...
 *
 * Parents let their heirs (children) use them as such or override them (via methods)
 * and to specify own, more detailed ones.
 * It is possible owing to the inheritance.
 * */

public class Dweller {

    void delveIntoAnthill() {
        // to be continued
    }
